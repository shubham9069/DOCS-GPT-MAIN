  ...
  return (
    <>
      <div
        ...
        } duration-20 fixed md:static z-20 flex h-full flex-col border-r-2 bg-gray-50 transition-all`}
      >
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            ...
            }  mx-4 mt-4 flex h-12 cursor-pointer gap-4 rounded-md hover:bg-gray-100`
          }
        >
      ...
      ></Upload>
        <div className="flex flex-col-reverse my-6">
